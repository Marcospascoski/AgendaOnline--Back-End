...
namespace AgendaOnline.Repository.Migrations
{
    ...
    [Migration("20200310151134_AdcionandoPropriedadePassword2")]
    partial class AdcionandoPropriedadePassword2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgendaOnline.Domain.Agenda", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("AgendaOnline.Domain.Identity.UserRole", b =>
                {
                    ...
                    b.HasOne("AgendaOnline.Domain.Identity.User", "User")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("AgendaOnline.Domain.Identity.Role")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("AgendaOnline.Domain.Identity.User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
